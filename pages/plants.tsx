...
import PlantsProducts from "../models/allproducts/plantsall";
const mongoose = require("mongoose");

export default function Plants({ products }) {
  return (
...
export async function getServerSideProps(context) {
  if (!mongoose.connections[0].readyState) {
    await mongoose.connect(`${process.env.MONGO_URI}/plants`);
  }
  let products = await PlantsProducts.find();
  return {
